...
- **No "on a [weekday]" constructions in email drafts:** When drafting email on Jeremy's behalf (Gmail drafts, nudges, follow-ups, any outbound from his accounts), never write "on a Tuesday morning," "on a Wednesday afternoon," "on a Thursday," or any other indefinite-article + weekday phrasing. The "a" before a day name sounds generic and slightly narrative ("we met on a Tuesday morning" reads like fiction, not business), and it is not how Jeremy writes. This pattern creeps in when you convert a calendar timestamp or email header to prose — watch for it there specifically. Correct alternatives, in order of preference: (1) the specific date ("on Apr 15"), (2) the definite form ("on Tuesday morning" or just "Tuesday morning"), or (3) a concrete anchor ("at our breakfast last week," "after Tuesday's call"). Review every draft before presenting or saving and strip any "on a [Monday/Tuesday/.../Sunday]" phrase. Scope is outbound emails; internal repo text, journals, and briefings to Jeremy are fine.
